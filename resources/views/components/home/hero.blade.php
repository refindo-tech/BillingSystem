    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-12 pt-0 z-10">
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex z-10">
            ...
            <div class="relative w-full h-96 lg:h-full">
                ...
                <img src="{{ asset('images/hero/0.png') }}" alt="hero" class="absolute top-[20%] left-12 w-[35%] animate-float-1">
                <img src="{{ asset('images/hero/0.png') }}" alt="hero" class="absolute top-[43%] left-0 w-[35%] animate-float-2">
                <img src="{{ asset('images/hero/0.png') }}" alt="hero" class="absolute bottom-[20%] -left-12 w-[35%] animate-float-3">
            </div>
        </div>                
    </div>
</section>
