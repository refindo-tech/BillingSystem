    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="px-2 my-5 menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold px-lg-0"
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <span class="menu-link">
                            <span class="menu-title text-xl" id="kt_current_date">
                                {{ now()->format('l, F j, Y') }}
                            </span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-title text-xl" id="kt_current_time">
                                Current Time
                            </span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                ...
                {{-- <div class="px-2 my-5">
                    <span class="fw-semibold fs-6 text-gray-700">TEST</span>
                </div> --}}
...
<script>
    function updateTime() {
        ...
        document.getElementById("kt_current_time").innerHTML = currentTimeString;
    }
