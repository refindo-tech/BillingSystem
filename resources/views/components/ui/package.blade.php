    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="relative pt-12">
            ...
            <div
                ...
                <x-ui.packageCard title="CORP50" description="Paket Internet Coreporate sangat setabil dengan Wireless support dual band 2.4Ghz dan 5Ghz membuat semakin berselancar semakin ngacir. Cocok untuk Sekolah atau Café yang membutuhkan Internet kwalitas prima dan mendapatkan layanan prioritas."
                    price="500K" :features="[
                        'Jaringan Fiber Optik',
                        'Unlimited, Tanpa Batas Quota!',
                        'Speed up to 50 Mbps',
