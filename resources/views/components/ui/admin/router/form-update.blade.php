<div id="drawer-update-router-default"
        ...
        <h5 id="drawer-label"
            ...
            Update Router</h5>
        <button type="button" data-drawer-dismiss="drawer-update-router-default"
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="title" id="name"
                        ...
                        value="Education Dashboard" placeholder="Type router name" required="">
                </div>
                <div>
