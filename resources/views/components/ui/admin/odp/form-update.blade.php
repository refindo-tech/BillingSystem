<div id="drawer-update-odp-default"
    ...
    <h5 id="drawer-label"
        ...
        Update ODP</h5>
    <button type="button" data-drawer-dismiss="drawer-update-odp-default"
        aria-controls="drawer-update-odp-default"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nama_odp" id="nama_odp"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type ODP name" required="">
            </div>
            <div>
                <label for="merek"
