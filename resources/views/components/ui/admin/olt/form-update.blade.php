<div id="drawer-update-olt-default"
    ...
    <h5 id="drawer-label"
        ...
        Update OLT</h5>
    <button type="button" data-drawer-dismiss="drawer-update-olt-default"
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="nama" id="nama"
                    ...
                    placeholder="Type OLT name" required="">
            </div>
            <div>
                <label for="vendor"
            ...
            <div>
                ...
                <input type="text" name="script" id="script"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type script" required="">
            </div>
            <div>
                <label for="action"
                ...
                <input type="text" name="action" id="action"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type action" required="">
            </div>
        </div>
