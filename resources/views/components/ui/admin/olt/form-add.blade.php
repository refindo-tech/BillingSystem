<div id="drawer-create-olt-default"
...
<h5 id="drawer-label"
    ...
    OLT</h5>
<button type="button" data-drawer-dismiss="drawer-create-olt-default"
    aria-controls="drawer-create-olt-default"
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="vendor" id="vendor"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type vendor" required="">
        </div>
        <div>
            <label for="model"
            ...
            <input type="text" name="model" id="model"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type model" required="">
        </div>
        <div>
            <label for="jenis"
        ...
        <div>
            <label for="ip_remote"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">IP REMOTE</label>
            <input type="text" name="ip_remote" id="ip_remote"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type IP remote" required="">
        </div>
        <div>
            <label for="port"
            ...
            <input type="text" name="port" id="port"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type port" required="">
        </div>
        <div>
            <label for="community_read"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">COMMUNITY READ</label>
            <input type="text" name="community_read" id="community_read"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type community read" required="">
        </div>
        <div>
            <label for="community_write"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">COMMUNITY WRITE</label>
            <input type="text" name="community_write" id="community_write"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type community write" required="">
        </div>
        <div>
            <label for="script"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SCRIPT</label>
            <textarea name="script" id="script"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type script" required=""></textarea>
        </div>
