        ...
        <div class="card card-flush">
            ...
            <div class="card-body" x-data="rechargeVoucherForm()" x-init="init()">
                ...
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework flex flex-col gap-5" method="POST"
                    ...
                    @endif
                    <x-form.group.select name="plan_type" label="Type" :options="$planTypes" required :value="old('plan_type', @$voucher['plan_type'] ?? @$defaultPlanType?->value)"
                        :readonly="$mode == 'edit'" />
                    ...
                    <x-form.group.select name="format" :options="$voucherFormats" required :value="$defaultVoucherFormat"
