    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-0 lg:px-6">
        ...
        <div class="relative pt-12">
            ...
            <div
                ...
                <x-ui.packageCard2 title="CORP50" description="Paket Internet Coreporate sangat setabil dengan Wireless support dual band 2.4Ghz dan 5Ghz membuat berselancar semakin ngacir. Cocok untuk Sekolah atau Cafe yang membutuhkan Internet kualitas prima dan mendapatkan layanan prioritas."
                    price="500K" :features="[
                        'Biaya pemasangan 1juta',
                        'Jaringan Fiber Optik',
                        'Unlimited, Tanpa Batas Quota!',
