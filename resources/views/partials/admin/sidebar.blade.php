<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <!--begin::Logo-->
    <div class="app-sidebar-logo px-6 bg-white"
    id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="{{route('admin:dashboard')}}">
            <img alt="Logo" src="{{ asset('assets/media/logos/logo-small.png') }}"
                class="h-50px px-10 app-sidebar-logo-default" />
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="{{ route('admin:log.index') }}"
            ...
            title="Sejarah Aktivitas Pengguna">
            <span class="btn-label">Application Logs</span>
