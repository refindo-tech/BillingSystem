<div id="drawer-create-odp-default"
...
<h5 id="drawer-label"
    ...
    ODP</h5>
<button type="button" data-drawer-dismiss="drawer-create-odp-default"
    aria-controls="drawer-create-odp-default"
...
<form action="#">
    <div class="space-y-4">
        ...
        <div>
            <label for="nama_odp"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NAMA ODP</label>
            <input type="text" name="nama_odp" id="nama_odp"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type nama ODP" required="">
        </div>
        <div>
            <label for="merek"
            ...
            <input type="text" name="merek" id="merek"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type merek" required="">
        </div>
        <div>
            <label for="jumlah_port"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">JUMLAH PORT</label>
            <input type="text" name="jumlah_port" id="jumlah_port"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type jumlah port" required="">
        </div>
        <div>
            <label for="lokasi_terpasang"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">LOKASI TERPASANG</label>
            <input type="text" name="lokasi_terpasang" id="lokasi_terpasang"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type lokasi terpasang" required="">
        </div>
        <div>
            <label for="koordinat"
            ...
            <input type="text" name="koordinat" id="koordinat"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Type koordinat" required="">
        </div>
