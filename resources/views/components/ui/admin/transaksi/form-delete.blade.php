<div id="drawer-delete-transaksi-default"
...
<h5 id="drawer-label"
    ...
    TRANSAKSI</h5>
<button type="button" data-drawer-dismiss="drawer-delete-transaksi-default"
    aria-controls="drawer-delete-transaksi-default"
...
<h3 class="mb-6 text-lg text-gray-500 dark:text-gray-400">Are you sure you want to delete this TRANSAKSI?</h3>
<a href="#"
...
<a href="#"
    ...
    data-drawer-hide="drawer-delete-transaksi-default">
    No, cancel
</a>
</div>