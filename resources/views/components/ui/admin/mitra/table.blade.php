                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-{{ $mitra->id }}" aria-describedby="checkbox-1"
                                        type="checkbox"
                                        class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox-{{ $mitra->id }}" class="sr-only">checkbox</label>
                                </div>
                            </td>
                            ...
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $mitra->login_terakhir }}
                            </td>
                            <td class="p-4 space-x-2 whitespace-nowrap justify-end items-end flex">
                                <button type="button" id="updateMitraButton"
                                    data-drawer-target="drawer-update-mitra-default"
                                    data-drawer-show="drawer-update-mitra-default"
                                    aria-controls="drawer-update-mitra-default"
                                ...
                                <button type="button" id="deleteMitraButton"
                                    data-drawer-target="drawer-delete-mitra-default"
                                    data-drawer-show="drawer-delete-mitra-default"
                                    aria-controls="drawer-delete-mitra-default"
                                    data-drawer-placement="right"
