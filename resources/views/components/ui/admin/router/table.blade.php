                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        {{-- <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap justify-end items-end flex">
                                <button type="button" id="updateRouterButton"
                                    data-drawer-target="drawer-update-router-default"
                                    data-drawer-show="drawer-update-router-default"
                                    aria-controls="drawer-update-router-default"
                                ...
                                <button type="button" id="deleteRouterButton"
                                    data-drawer-target="drawer-delete-router-default"
                                    data-drawer-show="drawer-delete-router-default"
                                    aria-controls="drawer-delete-router-default"
                                    data-drawer-placement="right"
...
<x-ui.admin.router.form-update />
<x-ui.admin.router.form-delete />