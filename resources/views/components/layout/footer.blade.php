<footer class="mt-8 bg-violet-900 pt-9">
    <div class="max-w-screen-xl py-6 mx-auto">
      <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
        <div class="md:w-[316px]">
          ...
          <p class="mt-[18px] text-[15px] font-normal text-white/[80%]">Adalah Internet Service Provider (ISP) Legal dengan nomor izin penyelenggara 4919/TEL.04.02/2021 dan berlaku secara Nasional. Selaras dengan itu, YAMNET mendukung perluasan dan percepatan peningkatan keterjangkauan pemerataan layanan akses internet sekaligus mendorong pemanfaatan teknologi informasi dan komunikasi untuk tujuan peningkatan kecerdasan warga dan kesejahteraan masyarakat secara umum.</p>
        ...
        <div class="md:w-[316px]">
          ...
          <div class="mt-[23px] flex">
            ...
            <div class="ml-[18px]">
              <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">Jonggol, Bogor, 16820</a>
