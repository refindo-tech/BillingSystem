                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-{{ $transaksi->id }}" aria-describedby="checkbox-1"
                                        type="checkbox"
                                        class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox-{{ $transaksi->id }}" class="sr-only">checkbox</label>
                                </div>
                            </td>
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap justify-end items-end flex">
                                <button type="button" id="updateTransaksiButton"
                                    data-drawer-target="drawer-update-transaksi-default"
                                    data-drawer-show="drawer-update-transaksi-default"
                                ...
                                <button type="button" id="deleteTransaksiButton"
                                    data-drawer-target="drawer-delete-transaksi-default"
                                    data-drawer-show="drawer-delete-transaksi-default"
...
<x-ui.admin.transaksi.form-delete />
<x-ui.admin.transaksi.form-update />
