@props([
    'voucherProfiles' => [
        (object) [
            'id' => 1,
            'nama_profile' => 'Profile 1',
            'group' => 'Group 1',
            'addr_list' => 'Address List 1',
            'rate_limit' => '100',
            'shared' => 'Yes',
            'kuota' => '500',
            'durasi' => '30 days',
        ...
        (object) [
            'id' => 2,
            'nama_profile' => 'Profile 2',
            'group' => 'Group 2',
            'addr_list' => 'Address List 2',
            'rate_limit' => '200',
            'shared' => 'No',
            'kuota' => '1000',
            'durasi' => '60 days',
            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach ($voucherProfiles as $voucherProfile)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-{{ $voucherProfile->id }}" aria-describedby="checkbox-1"
                                        type="checkbox"
                                        class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox-{{ $voucherProfile->id }}" class="sr-only">checkbox</label>
                                </div>
                            </td>
                            ...
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->nama_profile }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->group }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->addr_list }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->rate_limit }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->shared }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->kuota }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->durasi }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->aktif }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->hpp }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->komisi }}
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                {{ $voucherProfile->hjk }}
                            </td>
                            <td class="p-4 space-x-2 whitespace-nowrap justify-end items-end flex">
                                <button type="button" id="updateVoucherProfileButton"
                                    data-drawer-target="drawer-update-voucher-profile-default"
                                    data-drawer-show="drawer-update-voucher-profile-default"
                                    aria-controls="drawer-update-voucher-profile-default"
                                ...
                                <button type="button" id="deleteVoucherProfileButton"
                                    data-drawer-target="drawer-delete-voucher-profile-default"
                                    data-drawer-show="drawer-delete-voucher-profile-default"
                                    aria-controls="drawer-delete-voucher-profile-default"
                                    data-drawer-placement="right"
...
<x-ui.admin.voucher.profile.form-delete />
